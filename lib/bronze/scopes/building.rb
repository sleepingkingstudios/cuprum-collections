...
module Bronze::Scopes
  ...
  module Building # rubocop:disable Metrics/ModuleLength
    ...
    module ClassMethods
      # @return [Bronze::Scopes::Builder] a singleton instance of the builder
      #   class.
      def instance
        @instance ||= new
      end
    ...
    def build(*args, &)
      if args.first.is_a?(Bronze::Scopes::Base)
    ...
    #
    # @param scopes [Array<Bronze::Scopes::Base>] the scopes to wrap in an AND
    #   scope.
    ...
    def validate_scope!(scope)
      return if scope.is_a?(Bronze::Scopes::Base)
