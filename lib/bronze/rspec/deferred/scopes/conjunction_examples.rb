...
require 'bronze/rspec/deferred/scopes'
require 'bronze/rspec/deferred/scopes/composition_examples'

module Bronze::RSpec::Deferred::Scopes
  ...
  module ConjunctionExamples
    ...
    include Bronze::RSpec::Deferred::Scopes::CompositionExamples
