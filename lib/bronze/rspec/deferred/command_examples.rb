...
module Bronze::RSpec::Deferred
  ...
  module CommandExamples
    ...
    deferred_examples 'should implement the Bronze::Commands::Base methods' do
    ...
    # @deprecated [0.6.0] Use "should implement the Bronze::Commands::Base
    #   methods" instead.
    deferred_examples 'should implement the CollectionCommand methods' do
      ...
      SleepingKingStudios::Tools::Toolbelt
        ...
        .core_tools
        .deprecate(
          'deferred_examples "should implement the CollectionCommand methods',
          'Use "should implement the Bronze::Commands::Base methods" instead.'
        )

      include_examples 'should implement the Bronze::Commands::Base methods'
      # :nocov:
    end
