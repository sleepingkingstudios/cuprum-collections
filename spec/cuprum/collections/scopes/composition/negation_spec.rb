...
RSpec.describe Cuprum::Collections::Scopes::Composition::Negation do
  ...
  do |klass|
    ...
    klass.include Cuprum::Collections::Scopes::Composition::Negation # rubocop:disable RSpec/DescribedClass

    klass.define_method(:type) { :negation }
  end
