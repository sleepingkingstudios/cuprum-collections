...
RSpec.describe Cuprum::Collections::Scopes::Composition::Conjunction do
  ...
  do |klass|
    ...
    klass.include Cuprum::Collections::Scopes::Composition::Conjunction # rubocop:disable RSpec/DescribedClass

    klass.define_method(:type) { :conjunction }
  end
